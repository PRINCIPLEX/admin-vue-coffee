    ...
    <el-card>
      ...
      <el-table :data="orderlist" border stripe>
        ...
        <el-table-column align="center" label="处理">
          <template slot-scope="scope">
            <el-button size="mini" type="success" @click="setDeal(scope.row.id)">已处理</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页区域 -->
  ...
  export default {
    data() {
      return {
        ...
        showOrderForm: [],
        goodlist: [],
        webSocketPath: globalData.webSocketSrc + 'order',
        socket: '',
    ...
    methods: {
      ...
      async setDeal(id) {
        ...
        const {
          data: res
        } = await this.$http.get('setdeal/' + id, {
